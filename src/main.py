...
class TadoClient:
    ...
    def __init__(self):
        ...
        me_response = api_call("https://my.tado.com/api/v2/me", self.access_token)
        self.home_id = me_response["homes"][0]["id"]

    def set_temperature_offset(self, device: str, offset_value: float = -4.0):
